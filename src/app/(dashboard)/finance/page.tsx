            ...
            <tbody>
              {approved.map((t) => (
                <tr key={t.id} style={{ borderBottom: "1px solid rgba(255,255,255,0.05)", fontSize: "0.825rem" }}>
                  ...
                  <td style={{ padding: "0.875rem 1rem", textAlign: "right", color: "#86efac", fontWeight: "700" }}>{formatRs(Number(t.amount))}</td>
                  <td style={{ padding: "0.875rem 1rem" }}>
                    <span style={{ background: "rgba(34,197,94,0.12)", color: "#22c55e", padding: "0.15rem 0.4rem", borderRadius: "4px", fontSize: "0.65rem", fontWeight: "700" }}>
                      {t.status}
                    </span>
                  </td>
                </tr>
